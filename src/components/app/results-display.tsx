    ...
    <div className="space-y-8 mt-12 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-1 shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Candidate's alignment with the job.</CardDescription>
          </CardHeader>
        ...
        <Card className="lg:col-span-2 shadow-lg">
          <CardHeader>
            ...
            <CardDescription>An AI-generated summary of the candidate's profile.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>AI-generated questions to probe deeper into the candidate's skills.</CardDescription>
        </CardHeader>
        <CardContent>
